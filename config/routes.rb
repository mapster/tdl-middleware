Rails.application.routes.draw do
    ...
    resource :users, only: [:show, :create, :update, :destroy], defaults: {format: :json} do
      ...
      resources :solutions, only: [:index, :show, :create, :update, :destroy], defaults: {format: :json} do
    ...
    namespace :admin do
        resources :users, only: [:index, :show, :create, :update, :destroy], defaults: {format: :json} do
            resource :user_authorizations, only: [:show, :update, :destroy], defaults: {format: :json}
        end
    end
